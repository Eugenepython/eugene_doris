...
function BondImageGame() {
    ...
    return (
      <>
        ...
        <p><a className = 'white' href="https://github.com/Eugenepython/JamesBondImageGame" target="_blank">Github source code</a></p>
     
        <p><a className = 'white' href="https://bond-image-match.netlify.app/" target="_blank">Website</a></p>
