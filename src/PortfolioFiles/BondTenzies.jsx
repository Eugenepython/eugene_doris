...
function BondTenzies() {
    ...
    return (
      <>
        ...
        <p><a className = 'white' href="https://github.com/Eugenepython/JamesBondTenzi" target="_blank">Github source code</a></p>
     
        <p><a className = 'white' href="https://james-bond-tenzies.netlify.app/" target="_blank">Website (mobile view)</a></p>
