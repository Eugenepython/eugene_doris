  ...
  return (
    <>
      <div>
        ...
        <p><a className='white' href="https://github.com/Eugenepython/ColorChooser" target="_blank" rel="noopener noreferrer">Github source code</a></p>

        <p><a className='white' href="https://colorscheme-chooser.netlify.app/" target="_blank" rel="noopener noreferrer">Website (mobile view)</a></p>
