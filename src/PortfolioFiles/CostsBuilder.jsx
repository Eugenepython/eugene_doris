...
function CostsBuilder() {
    ...
    return (
      <>
        ...
        <p><a className = 'white' href="https://github.com/Eugenepython/costsbuilder" target="_blank">Github source code</a></p>
        
        <p><a className = 'white' href="https://costsbuilder.netlify.app/" target="_blank">Website (mobile view)</a></p>
