  ...
  return (
    <>
      <div>
        ...
        <p><a className='white' href="https://github.com/Eugenepython/CostsCalculator" target="_blank" rel="noopener noreferrer">Github source code</a></p>

        <p><a className='white' href="https://costs-interest-calculator.netlify.app/" target="_blank" rel="noopener noreferrer">Website (mobile view)</a></p>
