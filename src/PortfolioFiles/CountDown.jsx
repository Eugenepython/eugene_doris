...
function CountDown() {
    ...
    return (
      <>
        ...
        <p><a className = 'white' href="https://github.com/Eugenepython/countdown" target="_blank">Github source code</a></p>
        
        <p><a className = 'white' href="https://countdownquiz.netlify.app/" target="_blank">Website (desktop view)</a></p>
