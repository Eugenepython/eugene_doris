  ...
  return (
    <>
      <div>
        ...
        <p><a className='white' href="https://github.com/Eugenepython/crypticBond" target="_blank" rel="noopener noreferrer">Github source code</a></p>

        <p><a className='white' href="https://cryptic-bond.netlify.app/" target="_blank" rel="noopener noreferrer">Website</a></p>
