...
function Fitness() {
    ...
    return (
      <>
        ...
        <p><a className = 'white' href="https://github.com/Eugenepython/RAILWAY-FITNESS" target="_blank"> Github page and source code</a></p>
       
        
        <p><a className = 'white' href="https://myfitness-client-production.up.railway.app/" target="_blank">Designed for phone screen.</a></p>
