  ...
  return (
    <>
      <div>
        ...
        <p><a className='white' href="hhttps://github.com/Eugenepython/journal" target="_blank" rel="noopener noreferrer"> Github page and source code</a></p>


        <p><a className='white' href="https://frontend-production-eda2.up.railway.app/" target="_blank" rel="noopener noreferrer">Designed for laptop screen.</a></p>
