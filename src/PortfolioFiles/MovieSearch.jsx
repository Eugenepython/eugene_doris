...
function MovieSearch() {
    ...
    return (
      <>
        ...
        <p><a className = 'white' href="https://github.com/Eugenepython/MovieSearch" target="_blank">First attempt Github page and source code</a></p>
       
        
        <p><a className = 'white' href="https://movie-search-and-list.netlify.app/" target="_blank">Website adapted for mobiles</a></p>
