...
function Quizzical() {
    ...
    return (
      <>
        ...
        <p><a className = 'white' href="https://github.com/Eugenepython/Quizzical" target="_blank">First attempt Github page and source code</a></p>
        <p><a className = 'white' href="https://github.com/Eugenepython/15may" target="_blank">Second attempt Github page and source code</a></p>
        
        <p><a className = 'white' href="https://quiz-yourself-with-react.netlify.app/" target="_blank">Website</a></p>
