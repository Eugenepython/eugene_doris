  ...
  return (
    <>
      <div>
        ...
        <p><a className='white' href="https://github.com/Eugenepython/TintinGame/" target="_blank" rel="noopener noreferrer">Github page and source code</a></p>
        <p><a className='white' href="https://tintin-image-matching-game.netlify.app/" target="_blank" rel="noopener noreferrer">Website</a></p>
