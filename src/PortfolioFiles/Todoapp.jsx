  ...
  return (
    <>
      <div>
        ...
        <p><a className='white' href="https://github.com/Eugenepython/todoapp" target="_blank" rel="noopener noreferrer"> Github page and source code</a></p>


        <p><a className='white' href="https://client-frontend-production.up.railway.app/" target="_blank" rel="noopener noreferrer">Website hosted on Railway</a></p>
